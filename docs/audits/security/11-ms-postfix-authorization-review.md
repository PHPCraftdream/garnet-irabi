...
- Invariant в документации ролей: `Apps/IRabi/docs/guides/product/roles.md:157-160` указывает, что owner назначается только администратором.
