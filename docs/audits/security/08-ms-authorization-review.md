...
- предыдущий отчет `docs/audits/security/08-ms-authorization-review.md`;
- `docs/audits/security/00-SUMMARY.md`;
- `docs/audits/security/01-foreground-controllers.md`;
- `docs/audits/security/02-dashboard-controllers.md`;
- `docs/audits/security/03-auth-middlewares.md`;
- `docs/audits/security/04-services-entities-db.md`;
- `docs/audits/security/05-uploads-external-im.md`;
- `docs/audits/security/06-frontend-xss.md`.
