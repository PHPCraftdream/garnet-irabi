...
- **Строка:** 235–313 (`post__book`), 171–230 (`post__bookData`); ср. `Foreground/Controllers/Booking/BookingsController.php:287–439` (`post__book`)
- **Severity:** Medium
...
- **Файл:** `Foreground/Middlewares/…` → гейт в `IRabi.php:209–212`; реализация в `Foreground/Controllers/Expert/ExpertPanel/ExpertSlotsService.php:192` (`createSlot`), `:331` (`batchSlots`), `:456` (`editSlot`); ср. `Foreground/Params/UserEntityConfig.php:154–156` (`isExpert`)
...
- **Файл:** `Foreground/Controllers/UsersController.php:28–147` (`post__preview`); `Foreground/Controllers/UserProfileController.php:38–97` (`get__main`); `Foreground/Controllers/Expert/ExpertPanel/ExpertSlotsService.php:117–187` (`userPreview`)
