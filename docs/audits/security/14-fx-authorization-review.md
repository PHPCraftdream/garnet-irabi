...
- Прочитаны авторитетные источники инвариантов: `docs/guides/product/roles.md`, `docs/uat/state-machine/*.md`, и `UserEntityConfig.php` (хелперы прав).
...
- Middleware-цепочки и role-gates в `IRabi.php` — соответствуют `docs/guides/product/roles.md` (moderator ⊆ owner ⊆ admin; expertOnly; ownerOnly для system/static-pages).
