...
namespace PHPCraftdream\IRabi {
    ...
    use PHPCraftdream\IRabi\Dashboard\Controllers\Comms\DashboardCommentsController;
    use PHPCraftdream\IRabi\Dashboard\Controllers\Comms\DashboardEmailQueueController;
    use PHPCraftdream\IRabi\Dashboard\Controllers\Comms\DashboardMailLogController;
    ...
    use PHPCraftdream\IRabi\Dashboard\Controllers\Money\DashboardBalancesController;
    use PHPCraftdream\IRabi\Dashboard\Controllers\Money\DashboardBookingsController;
    use PHPCraftdream\IRabi\Dashboard\Controllers\Money\DashboardCancellationsController;
    use PHPCraftdream\IRabi\Dashboard\Controllers\Money\DashboardFinanceController;
    use PHPCraftdream\IRabi\Dashboard\Controllers\Ops\DashboardEntityHistoryController;
    use PHPCraftdream\IRabi\Dashboard\Controllers\Ops\DashboardLogsController;
    use PHPCraftdream\IRabi\Dashboard\Controllers\Ops\DashboardRequestLogController;
    use PHPCraftdream\IRabi\Dashboard\Controllers\Ops\DashboardSystemController;
    use PHPCraftdream\IRabi\Dashboard\Controllers\People\DashboardInviteTokensController;
    ...
    use PHPCraftdream\IRabi\Foreground\Controllers\Accounts\DevLoginController;
    use PHPCraftdream\IRabi\Foreground\Controllers\Accounts\MagicLoginController;
    use PHPCraftdream\IRabi\Foreground\Controllers\Accounts\RegisterController;
    use PHPCraftdream\IRabi\Foreground\Controllers\Accounts\UserProfileController;
    use PHPCraftdream\IRabi\Foreground\Controllers\Accounts\UsersController;
    use PHPCraftdream\IRabi\Foreground\Controllers\Booking\BalanceController;
    ...
    use PHPCraftdream\IRabi\Foreground\Controllers\Comms\ImController;
    use PHPCraftdream\IRabi\Foreground\Controllers\Comms\NewsController;
    use PHPCraftdream\IRabi\Foreground\Controllers\Comms\SupportController;
    use PHPCraftdream\IRabi\Foreground\Controllers\Content\ExternalController;
    use PHPCraftdream\IRabi\Foreground\Controllers\Content\RobotsController;
    use PHPCraftdream\IRabi\Foreground\Controllers\Content\SitemapController;
    use PHPCraftdream\IRabi\Foreground\Controllers\Content\StaticPagesController;
    use PHPCraftdream\IRabi\Foreground\Controllers\Expert\ExpertController;
    ...
    use PHPCraftdream\IRabi\Foreground\Controllers\Sys\SysLogController;
    use PHPCraftdream\IRabi\Foreground\Controllers\Sys\SysOpcacheResetController;
