/**
 * Календарь эксперта против независимого расчёта дат: что приложение
 * считает недоступным и совпадает ли это с @hebcal/core.
 *
 * Часть разобранного calendar.spec.ts. Цепочка цела: шаги делят один
 * открытый мастер.
 */
