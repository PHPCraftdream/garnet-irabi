...
namespace PHPCraftdream\IRabi\Foreground\Controllers\Expert {
    use Closure;
    ...
    use PHPCraftdream\IRabi\Foreground\Controllers\Expert\ExpertPanel\ExpertSlotsService;
    ...
    class ExpertPanelController extends FrameworkController {
         ...
         * invariant (docs/guides/product/roles.md §3.4: без IS_APPROVED эксперт не виден
