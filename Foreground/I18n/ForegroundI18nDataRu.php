...
namespace PHPCraftdream\IRabi\Foreground\I18n {
    class ForegroundI18nDataRu {
        ...
        public static array $data = [
            ...
            // колонка показывала другое. Теперь строка прямо говорит, что
            // именно означает её собственная сумма.
            'Ledger_Note_ExpertKeepsPenalty' => 'эта сумма возвращена ученику; неустойку %s ₽ (%s%%) вы сохраняете как компенсацию за отменённое занятие',
