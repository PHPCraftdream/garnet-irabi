...
namespace PHPCraftdream\IRabi\Foreground\I18n\En {
    ...
    class EnEmail {
        public static array $data = [
            ...
            'Email_BookingMissedResponse_Subject' => 'Response window expired — %s',
            'Email_BookingMissedResponse_Title' => 'Response window expired',
            'Email_BookingMissedResponse_Body' => 'The expert did not confirm the booking before the session started. The booking was cancelled automatically and refunded.',
