...
namespace PHPCraftdream\IRabi\Dashboard\Controllers\People {
    ...
    use PHPCraftdream\IRabi\Common\Services\Accounts\ClearUserService;
    ...
    use PHPCraftdream\IRabi\Foreground\Controllers\Expert\ExpertPanel\ExpertBookingsService;
    ...
    class DashboardUsersController extends DashboardController {
        ...
        public static function post__setUserFlag(IGlobalReqParams $globals, IRouterUriParams $params): mixed {
            ...
            // Security audit A-01: IS_OWNER must be admin-only (docs/guides/product/roles.md
            // §5 "Назначение владельца — только админ") — an owner who is not
            // also an admin must not be able to mint new owners.
